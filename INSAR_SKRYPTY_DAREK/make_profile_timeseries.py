...
parser.add_argument("--a", default=1, type=str, required=True, help="Directory with input grid files")
args = parser.parse_args()
inputdir = args.a

# Opening grd file
list_of_files = glob.glob(inputdir + '/*ll.grd')
...
z_1 = float(subprocess.getoutput("gmt grdinfo " + last_file + " | grep z_min | awk '{print $3}'"))
z_2 = float(subprocess.getoutput("gmt grdinfo " + last_file + " | grep z_min | awk '{print $5}'"))
z_min = z_1 - 50
z_max = z_2 + 50
